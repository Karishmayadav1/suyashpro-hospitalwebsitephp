    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">Hypodermic Single Use Needles</h1>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="department-img">
					<img src="img/s10.jpg"  style="width: 900px; height: 400px; border-radius:25px;"   alt="" class="img-fluid">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">HYPODERMIC SINGLE USE NEEDLES</h3>
					...
					<ul class="list-unstyled department-service">
						...
						<li><i class="icofont-check mr-2"></i>Injection port with non return value is provided for additional medication.</li>
						<li><i class="icofont-check mr-2"></i>Port caps are color coded for instant size identification.</li>
