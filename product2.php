    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">I.V. Cannula</h1>
...
<section class="section department-single">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="department-img ml-5">
					<img src="img/s9.jpg"  style="width: 900px; height: 400px; border-radius:25px;"alt="" class="img-fluid">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">I.V.CANNULA</h3>
					...
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>I.V. Catheter with injection port</li>
						<li><i class="icofont-check mr-2"></i>injection port with non return valve is provided</li>
						<li><i class="icofont-check mr-2"></i>Port caps are colour coded for instant size identification</li>
						<li><i class="icofont-check mr-2"></i>Size : 14, 16, 18, 20, 22 & 24G</li>
						<li><i class="icofont-check mr-2"></i>Type of Syrings : 3 pcs</li>
						<li><i class="icofont-check mr-2"></i>Sterlie individually blister packed with medical grade paper.</li>
					</ul>
