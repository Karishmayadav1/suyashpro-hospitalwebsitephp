    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">SCALP VEIN SET</h1>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="department-img">
					<img src="img/s12.jpg"  style="width: 900px; height: 400px; border-radius:25px;" alt="" class="img-fluid">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">SCALP VEIN SET</h3>
					...
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>Super thin wall needle - Provides larger inner diameter that enables sufficient flow and smooth infusion.</li>
						<li><i class="icofont-check mr-2"></i>Unique wing design for gripping and fixing.</li>
						<li><i class="icofont-check mr-2"></i>Soft cler flexible tubing.</li>
						<li><i class="icofont-check mr-2"></i>Internationally accepted color coder to identify the gauge size.</li>
						<li><i class="icofont-check mr-2"></i>Sterile pack - ETO sterilization.</li>
